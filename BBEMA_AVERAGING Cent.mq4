...
extern string  Nama_EA                 = "BBEMA Averaging Cent";
...
label();
    ...
    double BBUp_6 = iBands(Symbol(),0,20,2,0,PRICE_CLOSE,MODE_UPPER,6);
    double BBLow_6 = iBands(Symbol(),0,20,2,0,PRICE_CLOSE,MODE_LOWER,6);   
    double BBUp_7 = iBands(Symbol(),0,20,2,0,PRICE_CLOSE,MODE_UPPER,7);
    double BBLow_7 = iBands(Symbol(),0,20,2,0,PRICE_CLOSE,MODE_LOWER,7);
    double BBUp_8 = iBands(Symbol(),0,20,2,0,PRICE_CLOSE,MODE_UPPER,8);
    double BBLow_8 = iBands(Symbol(),0,20,2,0,PRICE_CLOSE,MODE_LOWER,8);
